...
namespace SEProject
{
    public partial class ActSeven : Form
    {
        ...
        private void getCoins_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    coins = reader.GetInt32("inGameCurrency");
            ...
            label12.Text = coins.ToString();
            button3.Enabled = true;
        }

        private void getTokens_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    tokens = reader.GetInt32("realCurrency");
            ...
            label11.Text = tokens.ToString();
            getCoins.Enabled = true;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (currency != "" && bet != "" && nr != "")
            {
                if ((currency == "Coins" && Int32.Parse(bet) <= coins) || (currency == "Tokens" && Int32.Parse(bet) <= tokens))
                {
                    ...
                    switch (nr)
                    {
                        case "Exactly 0":
                            if (roll == 0)
                            {
                                ...
                                if (currency == "Coins")
                                    coins += Int32.Parse(bet) * 2;
                                else if (currency == "Tokens")
                                    tokens += Int32.Parse(bet) * 2;
                            }
                            else
                            {
                                label7.Text = "Too bad. Try again!";
                                if (currency == "Coins")
                                    coins -= Int32.Parse(bet);
                                else if (currency == "Tokens")
                                    tokens -= Int32.Parse(bet);
                            }
                            break;
                        case "Exactly 100":
                            if (roll == 100)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query1 = "update seproject.user set inGameCurrency = " + "'" + coins + "' where (username = '" + MyVal + "');";
            ...
            try
            {
                ...
                string Query2 = "update seproject.user set realCurrency = " + "'" + tokens + "' where (username = '" + MyVal + "');";
